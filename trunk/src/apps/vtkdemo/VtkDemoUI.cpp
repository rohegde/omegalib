...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VtkDemoUI::VtkDemoUI(TextureManager* texMng, FontManager* fontMng):
	myTexMng(texMng), myFontMng(fontMng)
{
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VtkDemoUI::initialize()
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VtkDemoUI::handleUIEvent(const UIEvent& evt)
{
	printf("click yay!\n");
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VtkDemoUI::draw(const DrawContext& context)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VtkDemoUI::update(const UpdateContext& context)
{
	myUI.update(context);
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool VtkDemoUI::handleEvent(const InputEvent& evt)
{
