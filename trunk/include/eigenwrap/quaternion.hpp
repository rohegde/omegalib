...
#ifndef __EIGENWRAP__QUATERNION__HPP__
#define __EIGENWRAP__QUATERNION__HPP__
...
public:
	...
	quaternion (const Quaternion::AngleAxisType &aa): Quaternion (aa) {}
...
//    if ( a == 0.0 )
//    {
//        EIGENWRAP_ERROR( "Division by zero.", EIGENWRAP_HERE );
//    }
//	a = 1.0 / a;
//	return quaternion( x() * a, y() * a, z() * a, w() * a );
//}
