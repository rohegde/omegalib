#ifndef __EIGENWRAP__VECTOR__HPP__
#define __EIGENWRAP__VECTOR__HPP__
...
//template< size_t M, typename T >
//
//const vector< M, T > vector< M, T >::UnitX()( 1, 0, 0 );
//template< size_t M, typename T >
//const vector< M, T > vector< M, T >::UnitY()( 0, 1, 0 );
//template< size_t M, typename T >
...
//    if ( index >= M )
//    {
//        EIGENWRAP_ERROR( "at() - index out of bounds", EIGENWRAP_HERE );
//    }
//    #endif
//    return array[ index ];
//}
...
//{
//    return std::min_element( begin(), end(), eigenwrap::math::abs_less< T >() ) - begin();
//}
//
//
//
...
//{
//    return std::max_element( begin(), end(), eigenwrap::math::abs_greater< T >() ) - begin();
//}
//*/
//
//
