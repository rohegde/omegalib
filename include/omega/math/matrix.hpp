#ifndef __EIGENWRAP__MATRIX__HPP__
#define __EIGENWRAP__MATRIX__HPP__

#include <eigenwrap/vmmlib_config.hpp>

#include <eigenwrap/matrix_functors.hpp>
#include <eigenwrap/vector.hpp>
#include <eigenwrap/exception.hpp>
#include <eigenwrap/enable_if.hpp>
...
#include <eigenwrap/Eigen/Core>
#include <eigenwrap/Eigen/Geometry>
...
//    // tensor, for api compatibility with old eigenwrap version. 
...
//			if ( col_index >= N ) 
//                EIGENWRAP_ERROR( "column index out of bounds", EIGENWRAP_HERE );
//			#endif
...
//		#ifdef VMMLIB_SAFE_ACCESSORS
//		if ( row_index > M ) 
//            EIGENWRAP_ERROR( "row index out of bounds", EIGENWRAP_HERE );
//		#endif
...
//        EIGENWRAP_ERROR( "at( row, col ) - index out of bounds", EIGENWRAP_HERE );
//    #endif
...
//{
//    if ( data.size() < M * N )
//        EIGENWRAP_ERROR( "index out of bounds.", EIGENWRAP_HERE );
//
...
//
//    if ( index >= N )
//        EIGENWRAP_ERROR( "get_column() - index out of bounds.", EIGENWRAP_HERE );
//
//    #endif
//    
...
//    
//    if ( index >= N )
//        EIGENWRAP_ERROR( "set_column() - index out of bounds.", EIGENWRAP_HERE );
//    
//    #endif
//
...
//    #ifdef VMMLIB_SAFE_ACCESSORS
//    if ( row_index >= M )
//        EIGENWRAP_ERROR( "get_row() - index out of bounds.", EIGENWRAP_HERE );
//    #endif
//
//    for( size_t col_index = 0; col_index < N; ++col_index )
//    {
...
//    #ifdef VMMLIB_SAFE_ACCESSORS
//    if ( row_index >= M )
//        EIGENWRAP_ERROR( "set_row() - index out of bounds.", EIGENWRAP_HERE );
//    #endif
//
//    for( size_t col_index = 0; col_index < N; ++col_index )
//    {
...
//{
//	typedef eigenwrap::matrix< M, N, TT > matrix_tt_type ;
