...
vtkCxxRevisionMacro(vtkEqualizerCamera, "$Revision: 1.70 $");
vtkStandardNewMacro(vtkEqualizerCamera);
#endif

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void vtkEqualizerCamera::Render(vtkRenderer *ren)
{
  double aspect[2];
  int  lowerLeft[2];
  int usize, vsize;
  ...
  // Equalizer specifies its own projection matrices.
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void vtkEqualizerCamera::UpdateViewport(vtkRenderer *ren)
{
  int  lowerLeft[2];
  int usize, vsize;
  ren->GetTiledSizeAndOrigin(&usize,&vsize,lowerLeft,lowerLeft+1);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void vtkEqualizerCamera::PrintSelf(ostream& os, vtkIndent indent)
{
